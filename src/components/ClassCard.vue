        ...
        <div class="router-div" :style="prop.style">
            ...
            <div class="text-start" >
                <div class="class-text text-start">
                    <h4>{{ cookClasses.ctitle }}</h4>
                </div>
                <div>
                    <h6>모집강사 : {{ cookClasses.mname }}</h6>
                </div>
                <div>
                    <h6>모집인원 : 17/{{ cookClasses.cpersoncount }}</h6>
                </div>
                <div class="info d-flex mb-3">
                    <div class="class-date border-left-solid me-3">강의날짜 : {{ cookClasses.cdday }}</div>
...
const cday = new Date(cookClasses.value.cdday);
